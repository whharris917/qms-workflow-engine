...
geography = NavigationForm(key="geography", label="Geography Quiz", mode="tabs", instruction="Five geography questions.", steps=[
    ...
    ScoreForm(key="geo-score", label="Results", instruction="Geography Quiz results.", answer_key={
        "geo-q1": "Nile",
        "geo-q2": "France",
...
science = NavigationForm(key="science", label="Science Quiz", mode="tabs", instruction="Five science questions.", steps=[
    ...
    ScoreForm(key="sci-score", label="Results", instruction="Science Quiz results.", answer_key={
        "sci-q1": "Au",
        "sci-q2": "206",
...
history = NavigationForm(key="history", label="History Quiz", mode="tabs", instruction="Five history questions.", steps=[
    ...
    ScoreForm(key="hist-score", label="Results", instruction="History Quiz results.", answer_key={
        "hist-q1": "1989",
        "hist-q2": "Augustus",
...
quizzes = NavigationForm(key="quizzes", label="Quizzes", mode="tabs", instruction="Pick a quiz.", steps=[
    geography,
    science,
    history,
])
